...
public class Reservation {
    ...
    public Reservation(int id, String name, String sex, int age, String address, long mobileNo, String modeOfPayment, String className, String seatPreferences, int ticketQuantity, String origin, String destination, Date date, long pnr) {
        this.id = id;
        this.name = name;
        this.sex = sex;
        this.age = age;
